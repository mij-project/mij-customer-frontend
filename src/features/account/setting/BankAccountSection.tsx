...
export default function BankAccountSection({
  ...
  if (!bankAccount) {
    return (
      <div className="bg-white border border-gray-200 rounded-lg p-6 flex items-stretch justify-between">
        ...
        <div
          className="flex items-center justify-center p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100"
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6 flex items-stretch justify-between">
      <p className="text-lg font-semibold text-gray-900 self-center">振込先</p>
      <div
        className="flex items-center justify-end p-4 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 space-x-8"
        onClick={handleBankAccountChange}
      >
        <div>
          ...
          <div className="text-sm text-gray-600">
            {ACCOUNT_TYPE_MAP[bankAccount.account_type as keyof typeof ACCOUNT_TYPE_MAP]}{' '}
