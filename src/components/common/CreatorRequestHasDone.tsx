...
interface CreatorRequestHasDoneProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function CreatorRequestHasDone({ isOpen, onClose }: CreatorRequestHasDoneProps) {
          ...
          <div className="bg-white rounded-2xl p-6 shadow-2xl">
            ...
            <div className="text-center mb-8">
              ...
              <Dialog.Description asChild>
                <p className="text-green-600 font-bold text-sm">クリエイター登録済み</p>
              </Dialog.Description>
            </div>
