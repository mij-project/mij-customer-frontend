      ...
      <div className="p-6 space-y-6 mt-16">
        ...
        <div className="space-y-4 w-full">
          <div className="flex items-center justify-between">
            <Label htmlFor="message" className="text-sm font-medium text-gray-700">メッセージ受信</Label>
            <Switch id="message" checked={message} onCheckedChange={setMessage} />
          </div>
          <div className="flex items-center justify-between">
            <Label htmlFor="planJoin" className="text-sm font-medium text-gray-700">プラン加入時</Label>
            <Switch id="planJoin" checked={planJoin} onCheckedChange={setPlanJoin} />
          </div>
          <div className="flex items-center justify-between">
            <Label htmlFor="planCancel" className="text-sm font-medium text-gray-700">プラン解約時</Label>
