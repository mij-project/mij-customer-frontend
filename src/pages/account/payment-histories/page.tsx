                        ...
                        <Table className="min-w-[480px]">
                            <TableHeader className="bg-[#333333] hover:bg-[#333333]">
                                <TableRow className="bg-[#333333] hover:bg-[#333333]">
                                    ...
                                    <TableHead className="border-r border-gray-200 text-xs font-medium text-white text-center">タイトル</TableHead>
                                    <TableHead className='border-r border-gray-200 text-xs font-medium text-white text-left'>日付</TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
                                {
                                    paymentHistories.map((paymentHistory) => (
                                        <TableRow key={paymentHistory.id}>
                                            ...
                                            <TableCell className="text-center border-r border-gray-200">
                                                {paymentHistory.payment_type === 2 ? (
                                                    <Link
                                                        to={`/plan/detail?plan_id=${paymentHistory.plan_id}`}
                                            ...
                                            <TableCell className="text-left">{convertDatetimeToLocalTimezone(paymentHistory.paid_at)}</TableCell>
                                        </TableRow>
                                    ))
                                }
                            </TableBody>
