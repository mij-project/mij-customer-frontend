...
const BranchSelectPage: React.FC = () => {
  ...
  const handleSelectBranch = (branch: ExternalBranch) => {
    navigate(
      `/account/settings/bank-account/bank-setting?bank_code=${bank_code}&branch_code=${branch.code}`,
      { replace: true }
    );
  };
    ...
    <div className="min-h-screen bg-white px-6 pt-10">
      ...
      <div className="divide-y divide-gray-200">
        ...
        {branches.length === 0 && !loading && (
          <div className="py-6 text-center text-sm text-gray-400">該当する支店がありません</div>
        )}
      </div>
      <BottomNavigation />
    </div>
